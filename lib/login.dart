        ...
        child: Column(
          children: [
                ...
                Positioned(
                  ...
                  child: Container(
                      ...
                      child: IconButton(
                          ...
                          icon: isObscure ? Icon(FontAwesomeIcons.eye, size: 20, color: Colors.black,) : Icon(FontAwesomeIcons.eyeSlash, size: 20, color: Colors.black,)
                      )
                  ),
                ),
              ],
            ...
            TextButton(
                ...
                child: Text("Don't have an account?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.black),)
            )
          ],
        ),
        )
